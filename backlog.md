...
1. The enemies should be generated evenly throught the map.

>How to test: Launch a new game and see the position of the enemies.
...
## Interaction between enemies and the player
1. When the player collides with an enemy, a star point should be deducted.

>How to test: Try to collide with an enemy and observe the healst bar in top of the screen.
...
## Mud tiles
1. On the map there should also be geneated mud tiles, slowing dow the player and the opponenets when they move on them.

>How to test: Launch a new game, find a muddy region (marked by brown tiles) and try to move through it. Notice how your movement speed is slowed.

## Enemy variant 1 - greedy
1. Red enemies should search for the player using a greedy pathfinding algorithm.

>How to test: Launch a new game and observe how red enemies move, notice how they not always are able to find the most optimal path to your location, sometimes getting stuck.

## Enemy variant 2 - dijkstra
1. Blue enemies should search for the player using a dijkstra pathfinding algorithm.

>How to test: Launch a new game and observe how blue enemies move, notice how they are able to find a relatively optimal path to your location, however it is not always the best route.

## Enemy variant 3 - a*
1. Green enemies should search for the player using a a* pathfinding algorithm.

>How to test: Launch a new game and observe how green enemies move, notice how they are able to find an optimal path to your location avoiding mud tiles.
